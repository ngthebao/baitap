...
class ImageMonAn : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_image_mon_an)
        ...
        val imageAdapter = ImageTheLoaiAdapter(this, imageUrls, object : ImageTheLoaiAdapter.OnClickItemListener {
            override fun onClickItem(position: Int) {
                ...
                resultIntent.putExtra("anhmonan", selectedImageUrl)
        ...
        val storageRef = FirebaseStorage.getInstance().getReference("imagemonans")
